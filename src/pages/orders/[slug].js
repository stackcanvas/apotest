            ...
            <div className="relative">
                  ...
                  <div className="grid grid-flex-row grid-cols-12 gap-5 items-center">
                    ...
                    <div className="col-span-12 lg:col-span-6">
                      <div className="flex items-center space-x-5">
                        ...
                        <p>
                          Klamydia kan først testes for efter 5 dage. Vent
                          derfor med at foretage testen til der er gået 5 dage
                          fra sidste gang du havde ubeskyttet sex.
                        </p>
                      </div>
                    ...
                    <div className="col-span-12 lg:col-span-6">
                      ...
                      <h3 className="mb-1">
                        Hvordan testen skal udføres afhænger af om du har en
                        penis eller en vagina.
                      </h3>
                    </div>
                    ...
                    <div className="col-span-12 lg:col-span-6">
                      <h3>
                        Jeg bekræfter på to og love at overstående oplysninger
                        er korrekte.
                      </h3>
                    </div>
              ...
              {step.length === 4 && step.includes("3") && (
                <>
                  ...
                  <p className="max-w-[730px] mb-10">
                    Har du bestilt en test inden kl 14.00 på en hverdag
                    modtafger du din bestilling i aften mellem kl 18.00 og
                    22.00. Ellers modtager du den i samme tidsrum næste
                    hverdagsaften.
                  </p>

                  <p className="max-w-[730px] mb-10">
                    Du modtager snart en mail med bekræftelse på din bestilling.
                    I mailen står der detaljer til din bestilling der er være
                    vigtige for dig at læse. Hvis du ikke modtager mailen
                    indenfor de næste 30 minutter skal du se efter den i din
                    spam mappe. Hvis den ikke er der skal du skrive til os på
                    info@apotest.dk. Så sender vi den til dig igen.
                  </p>
